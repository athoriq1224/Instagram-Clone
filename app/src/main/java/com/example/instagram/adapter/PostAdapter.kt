...
class PostAdapter (private val mContext: Context,private val mPost:List<Post>): RecyclerView.Adapter<PostAdapter.ViewHolder>(){
    ...
    class ViewHolder(@NonNull itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        var  comment: TextView = itemView.findViewById(R.id.post_comment)
    ...
    private fun NumberOfLikes(likes: TextView, post: String) {
        val likeRef = FirebaseDatabase.getInstance().reference
            .child("Likes").child(post)
    ...
    private fun isLikes(post: String, likeButton: ImageView) {
